...
> = {
  landscapeWide: {
    ...
    sizes: [
      {label: '20 x 10', price: '$54.99'},
      {label: '30 x 15', price: '$89.99'},
      {label: '40 x 20', price: '$129.99'},
      {label: '48 x 24', price: '$139.99', badge: 'Best Value'},
      {label: '60 x 30', price: '$309.99', badge: 'Museum'},
    ],
  },
  portraitTwoThree: {
    label: 'Portrait 2:3',
    ...
    sizes: [
      {label: '12 x 18', price: '$54.99'},
      {label: '16 x 24', price: '$69.99'},
      {label: '24 x 36', price: '$99.99', badge: 'Best Value'},
      {label: '32 x 48', price: '$219.99'},
      {label: '40 x 60', price: '$359.99', badge: 'Statement'},
    ],
  },
  portraitThreeFour: {
    label: 'Portrait 3:4',
    ...
    sizes: [
      {label: '12 x 16', price: '$54'},
      {label: '18 x 24', price: '$89'},
      {label: '24 x 32', price: '$129', badge: 'Best Value'},
      {label: '36 x 48', price: '$249'},
      {label: '45 x 60', price: '$339', badge: 'Statement'},
    ],
  },
  landscapeThreeTwo: {
    label: 'Landscape 3:2',
    ...
    sizes: [
      {label: '18 x 12', price: '$54.99'},
      {label: '24 x 16', price: '$69.99'},
      {label: '36 x 24', price: '$99.99', badge: 'Best Value'},
      {label: '48 x 32', price: '$219.99', badge: 'Popular'},
      {label: '60 x 40', price: '$359.99', badge: 'Statement'},
    ],
  },
  landscapeFourThree: {
    label: 'Landscape 4:3',
    ...
    sizes: [
      {label: '16 x 12', price: '$60'},
      {label: '24 x 18', price: '$99'},
      {label: '32 x 24', price: '$139', badge: 'Best Value'},
      {label: '48 x 36', price: '$249'},
      {label: '60 x 45', price: '$339', badge: 'Statement'},
    ],
  },
  squareStandard: {
    label: 'Square',
    ...
    sizes: [
      {label: '12 x 12', price: '$40'},
      {label: '16 x 16', price: '$59'},
      {label: '24 x 24', price: '$89', badge: 'Best Value'},
      {label: '30 x 30', price: '$94', badge: 'Popular'},
    ],
  },
}
