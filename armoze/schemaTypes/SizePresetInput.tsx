...
> = {
  ...
  portraitTwoThree: {
    ...
    sizes: [
      {label: '12 x 18', price: '$49.99'},
      {label: '16 x 24', price: '$64.99'},
      {label: '24 x 36', price: '$84.99', badge: 'Best Value'},
      {label: '32 x 48', price: '$169.99'},
      {label: '40 x 60', price: '$294.99', badge: 'Statement'},
    ],
  },
  portraitThreeFour: {
    label: 'Portrait 3:4',
    ...
    sizes: [
      {label: '12 x 16', price: '$49'},
      {label: '18 x 24', price: '$84'},
      {label: '24 x 32', price: '$114', badge: 'Best Value'},
      {label: '36 x 48', price: '$199'},
      {label: '45 x 60', price: '$274', badge: 'Statement'},
    ],
  },
  landscapeThreeTwo: {
    label: 'Landscape 3:2',
  ...
  landscapeFourThree: {
    ...
    sizes: [
      {label: '16 x 12', price: '$55'},
      {label: '24 x 18', price: '$94'},
      {label: '32 x 24', price: '$124', badge: 'Best Value'},
      {label: '48 x 36', price: '$199'},
      {label: '60 x 45', price: '$274', badge: 'Statement'},
    ],
  },
  squareStandard: {
    label: 'Square',
    ...
    sizes: [
      {label: '12 x 12', price: '$35'},
      {label: '16 x 16', price: '$54'},
      {label: '24 x 24', price: '$39', badge: 'Best Value'},
      {label: '30 x 30', price: '$29', badge: 'Popular'},
    ],
  },
}
