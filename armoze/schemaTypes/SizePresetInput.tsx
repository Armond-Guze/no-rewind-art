...
> = {
  landscapeWide: {
    ...
    sizes: [
      {label: '20 x 10', price: '$75'},
      {label: '30 x 15', price: '$95'},
      {label: '40 x 20', price: '$115'},
      {label: '48 x 24', price: '$135', badge: 'Best Value'},
      {label: '60 x 30', price: '$165', badge: 'Museum'},
    ],
  },
  portraitTwoThree: {
    label: 'Portrait 2:3',
    ...
    sizes: [
      {label: '12 x 18', price: '$75'},
      {label: '16 x 24', price: '$95'},
      {label: '24 x 36', price: '$115', badge: 'Best Value'},
      {label: '32 x 48', price: '$135'},
  ...
  landscapeThreeTwo: {
    ...
    sizes: [
      {label: '18 x 12', price: '$75'},
      {label: '24 x 16', price: '$95'},
      {label: '36 x 24', price: '$115', badge: 'Best Value'},
      {label: '48 x 32', price: '$155', badge: 'Popular'},
      {label: '60 x 40', price: '$195', badge: 'Statement'},
    ],
  },
  landscapeFourThree: {
    label: 'Landscape 4:3',
