...
function normalizeAttributionTouch(value) {
  ...
  return {
    ...
    adGroupId: sanitizeAttributionValue(value.adGroupId, 150),
    adId: sanitizeAttributionValue(value.adId, 150),
    adAccountId: sanitizeAttributionValue(value.adAccountId, 150),
    ...
    oppref: sanitizeAttributionValue(value.oppref, 250),
  };
}
...
function buildStripeAttributionMetadata(attribution) {
  ...
  return compactMetadata({
    ...
    attributionTerm: attribution.lastTouch.term,
    ...
    attributionOppref: attribution.lastTouch.oppref,
    attributionCampaignId: attribution.lastTouch.campaignId,
    attributionAdGroupId: attribution.lastTouch.adGroupId,
    attributionAdId: attribution.lastTouch.adId,
    attributionAdAccountId: attribution.lastTouch.adAccountId,
...
function getAttributionFromStripeMetadata(metadata = {}) {
  ...
  const lastTouch = normalizeAttributionTouch({
    ...
    oppref: metadata.attributionOppref,
    campaignId: metadata.attributionCampaignId,
    adGroupId: metadata.attributionAdGroupId,
    adId: metadata.attributionAdId,
    adAccountId: metadata.attributionAdAccountId,
  });
