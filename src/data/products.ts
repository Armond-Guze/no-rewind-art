...
export const products: Product[] = [
  {
    ...
    image: imagePath('reminder life has no rewinder file', 'reminder life has no rewind  file.jpg'),
    imageAlt: 'Life Has No Rewind motivational cassette canvas print',
    artworkShape: 'landscape',
    gallery: [
      imagePath('reminder life has no rewinder file', 'reminder life has no rewind  file.jpg'),
