...
function getStep(searchParams: URLSearchParams): AuthStep {
...
export function CustomAuthFlow() {
  ...
  function goToEmailStep() {
    setError('');
    setInfo('');
    setSearchParams(normalizedEmail ? { email: normalizedEmail } : {});
  }

  function goToPasswordStep(nextEmail = normalizedEmail) {
    setError('');
    setInfo('');
    setSearchParams({ password: '1', email: nextEmail });
  }

  function goToVerifyStep(nextEmail = normalizedEmail) {
    setError('');
    setInfo('');
    setSearchParams({ verify: '1', email: nextEmail });
  }
